...
- new sub-stepping solver (_Soft Step_)
...
There is a new solver that uses sub-stepping called _Soft Step_. Instead of specifying velocity iterations or position iterations, you now specify the number of sub-steps.
