...
In the following discussion I use _body_ interchangeably with rigid body.
...
a handle called an _id_. These ids are opaque and are passed to various functions
